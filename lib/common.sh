...
# Test quality validation defaults
export HOOKS_DEFAULT_TEST_QUALITY_ENABLED=true
export HOOKS_DEFAULT_TEST_COVERAGE_ENABLED=false
export HOOKS_DEFAULT_TEST_COVERAGE_THRESHOLD=80
export HOOKS_DEFAULT_TEST_QUALITY_LEVEL=1
export HOOKS_DEFAULT_TEST_QUALITY_STRICT=false
...
hooks_load_config() {
  ...
  # Test quality validation settings
  HOOKS_TEST_QUALITY_ENABLED=${HOOKS_DEFAULT_TEST_QUALITY_ENABLED}
  HOOKS_TEST_COVERAGE_ENABLED=${HOOKS_DEFAULT_TEST_COVERAGE_ENABLED}
  HOOKS_TEST_COVERAGE_THRESHOLD=${HOOKS_DEFAULT_TEST_COVERAGE_THRESHOLD}
  HOOKS_TEST_QUALITY_LEVEL=${HOOKS_DEFAULT_TEST_QUALITY_LEVEL}
  HOOKS_TEST_QUALITY_STRICT=${HOOKS_DEFAULT_TEST_QUALITY_STRICT}
  ...
  # Export test quality validation settings
  export HOOKS_TEST_QUALITY_ENABLED
  export HOOKS_TEST_COVERAGE_ENABLED
  export HOOKS_TEST_COVERAGE_THRESHOLD
  export HOOKS_TEST_COVERAGE_INCLUDE
  export HOOKS_TEST_COVERAGE_EXCLUDE
  export HOOKS_TEST_QUALITY_LEVEL
  export HOOKS_TEST_QUALITY_STRICT
}
